        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('projet.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-message">objectif_specifiques</label>
                        <div class="col-sm-10">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="zone"
                                        placeholder="Zone" />
                                </div>

                                <div class="mb-3 row">
                                    <label for="html5-date-input" class="col-md-2 col-form-label">DateDebut</label>
                                    <div class="col-md-10">
                                        <input name="date_debut" class="form-control" type="date" value="2021-06-18"
                                            id="html5-date-input" />
                                    ...
                                    <div class="col-md-10">
                                        <input name="date_fin" class="form-control" type="date" value="2021-06-18"
                                            id="html5-date-input" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="fichier_projets[]" class="form-control" type="file" multiple />
                                </div>
